...
(deffacts products
    (product (type smartphone) (name iPhone13) (company apple) (color red) (price 15000))
    (product (type smartphone) (name xiaomi) (company motorola) (color blue) (price 8000))
    (product (type smartphone) (name SamsungNote12) (company samsung) (color black) (price 10000))
    (product (type computer) (name Thinkpad) (company lenovo) (color black) (price 9000))
    ...
    (product (type laptop) (name MacbookAir) (company apple) (color gris) (price 18000))
